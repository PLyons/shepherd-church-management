...
import { Form990Data } from '../../../types/donations';
...
export const Form990Report: React.FC<Form990ReportProps> = ({
  className = '',
}) => {
  ...
  const loadCategories = useCallback(async () => {
    try {
      ...
      await donationCategoriesService.getCategoriesByForm990LineItem(
      ...
      <div className={`bg-white rounded-lg shadow-sm border p-6 ${className}`}>
        <div className="text-center py-8">
          <p className="text-gray-500">
            No Form 990 data available for {selectedTaxYear}
          </p>
        </div>
      </div>
    );
    ...
    <div className={`bg-white rounded-lg shadow-sm border ${className}`}>
      ...
      <div className="p-6 space-y-8">
        ...
        <div
          ...
          data-testid="irs-compliance-disclaimer"
        >
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  ...
                  requirements for tax-exempt organizations. The information
                  provided is based on the organization's donation records and
                  should be reviewed by qualified tax professionals before
                  filing with the IRS. Consult with qualified tax professionals
                  for official Form 990 preparation and filing.
                </p>
              </div>
            </div>
          </div>
        ...
        <div
          ...
          data-testid="form-990-summary"
        >
          <div className="bg-blue-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-blue-900 mb-2">
              Total Revenue: {formatCurrency(form990Data.totalRevenue)}
            </h3>
            <p className="text-sm text-blue-700">
              Tax Year {form990Data.taxYear}
            </p>
          </div>
          <div className="bg-green-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-green-900 mb-2">
              Cash Contributions:{' '}
              {formatCurrency(form990Data.contributions.cash)}
            </h3>
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-purple-900 mb-2">
              ...
              {formatCurrency(form990Data.contributions.nonCash)}
            </h3>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  ...
                  <td
                    ...
                    data-testid="form-990-cash-contributions"
                  >
                    {formatCurrency(
                      form990Data.partVIII['1a_cash_contributions']
                    )}
                  </td>
                </tr>
                <tr className="bg-white">
                  ...
                  <td
                    className="px-4 py-3 text-sm text-gray-900 text-right"
                    data-testid="form-990-noncash-contributions"
                  >
                    {formatCurrency(
                      form990Data.partVIII['1b_noncash_contributions']
                    )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="px-4 py-3 text-sm text-gray-900 text-right"
                    data-testid="form-990-government-grants"
                  >
                    {formatCurrency(
                      form990Data.partVIII['1e_government_grants']
                    )}
                  </td>
                </tr>
                <tr className="bg-white">
                  ...
                  <td
                    className="px-4 py-3 text-sm text-gray-900 text-right"
                    data-testid="form-990-program-revenue"
                  >
                    {formatCurrency(
                      form990Data.partVIII['2_program_service_revenue']
                    )}
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="px-4 py-3 text-sm text-gray-900 text-right"
                    data-testid="form-990-investment-income"
                  >
                    {formatCurrency(
                      form990Data.partVIII['3_investment_income']
                    )}
                  </td>
                </tr>
              </tbody>
        ...
        <div data-testid="form-990-special-events">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Includes auction items, dinner events, and other special
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <span className="text-sm text-gray-900">
                        {formatCurrency(disclosure.totalAmount)}
                      </span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-700">
                      ...
                      <span className="text-sm text-gray-900">
                        {formatCurrency(disclosure.quidProQuoValue)}
                      </span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-700">
                      ...
                      <span className="text-sm text-gray-900">
                        {formatCurrency(disclosure.deductibleAmount)}
                      </span>
                    </div>
                  </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-900">
                    {formatCurrency(2400.0)}
                  </span>
                </div>
              </div>
              <p className="text-sm text-gray-600 mt-2">
                Values based on qualified appraisals and donor documentation.
                Professional appraisal required for non-cash contributions over
                $5,000.
              </p>
            </div>
          </div>
