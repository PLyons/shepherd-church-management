      ...
      <div className="space-y-1">
              ...
              <div className="flex items-start justify-between">
                ...
                {hasCapacityInfo(event) && (
                  <div className="ml-1 flex-shrink-0">
                    <div className={`w-2 h-2 rounded-full ${getCapacityStatus(event).full ? 'bg-red-500' : 'bg-green-500'}`} />
                  </div>
                )}
              </div>
                  ...
                  <div className="space-y-1 text-xs text-gray-500">
                    ...
                    {hasCapacityInfo(event) && (
                      <div className="flex items-center">
                        ...
                        <span className={`ml-1 ${getCapacityStatus(event).color}`}>
        ...
        {hasMoreEvents && (
          <div className="text-xs text-gray-500 p-1 bg-gray-50 rounded border border-gray-200">
            +{sortedEvents.length - 3} more event{sortedEvents.length - 3 !== 1 ? 's' : ''}
          </div>
        )}
      </div>
    </div>
