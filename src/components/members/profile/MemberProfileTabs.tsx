        ...
        {visibleTabs.map((tab) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                `group inline-flex items-center py-4 px-1 border-b-2 border-l-0 border-r-0 border-t-0 font-medium text-sm whitespace-nowrap transition-colors focus:outline-none focus:ring-0 focus:border-blue-500 ${
                  isActive
