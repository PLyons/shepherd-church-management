...
export function PastorDashboard({ member }: PastorDashboardProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">Church Members</dt>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">Ministry Events</dt>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                <dt className="text-sm font-medium text-gray-500 truncate">Giving (Monthly)</dt>
                <dd className="flex items-baseline">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Ministry Actions</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-900">Ministry Events</h2>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-900">Member Engagement</h2>
            <Link to="/members" className="text-blue-600 hover:text-blue-500 text-sm font-medium flex items-center">
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-medium text-gray-900">Active Members</h4>
                  <p className="text-sm text-gray-500">Attended event in last 30 days</p>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-semibold text-green-600">{stats.activeMembers || 0}</div>
                  <div className="text-sm text-gray-500">of {stats.totalMembers || 0}</div>
                </div>
              </div>
              
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-medium text-gray-900">New Members</h4>
                  <p className="text-sm text-gray-500">Joined in last 60 days</p>
                </div>
                <div className="text-right">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-medium text-gray-900">Follow-up Needed</h4>
                  <p className="text-sm text-gray-500">Members needing pastoral care</p>
                </div>
                <div className="text-right">
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Recent Ministry Activity</h2>
        </div>
        <div className="divide-y divide-gray-200">
              ...
              <div key={activity.id} className="p-4">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    ...
                    {activity.type === 'rsvp' && <Activity className="w-5 h-5 text-purple-500" />}
                  </div>
      ...
      {/* Ministry Overview */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Ministry Health</h2>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div className="text-sm text-purple-700">
            <strong>Pastoral Access:</strong> You can view member information for pastoral care purposes and 
            aggregate giving data for ministry planning. Individual donation details require specific justification 
